  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          // FIXED: Forces all children (including Profile Card) to full width
          ...
          children: [
            ...
            coursesAsync.when(
              ...
              error: (e, _) {
                ...
                // ApiException is typically generated by the OpenAPI generator
                bool is404 = false;
                if (e is ApiException && e.code == 404) {
                  is404 = true;
                } else if (e.toString().contains("404")) {
                  // Fallback string check if type matching fails
                  is404 = true;
                }
                ...
                if (is404) {
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.calendar_month_sharp, size: 40, color: Colors.grey.shade300),
                        const SizedBox(height: 12),
                        Text(
                          "(No semesters in session)",
                          style: TextStyle(
                              fontSize: 14,
                ...
                return Text("Error loading courses: $e", style: const TextStyle(color: Colors.red));
              },
            ),
          ],
        ),
