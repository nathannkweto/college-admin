...
class LecturerDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      child: Column(
        children: [
          LecturerBranding(isCollapsed: isMobile ? false : isCollapsed),
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildNavItem(context, 1, "My Courses", Icons.class_outlined, isMobile),
                _buildNavItem(context, 2, "Grading & Results", Icons.assignment_turned_in_outlined, isMobile),
              ],
            ),
          ),
  ...
  Widget _buildNavItem(
    ...
    final color = isSelected ? Colors.orange : Colors.grey.shade700;
